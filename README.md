...
# notebooks/    01\_ingest ... 10\_baselines\_scale

# harm\_demo.py  interactive Gradio demo 
...
# python harm\_demo.py          # web UI (requires the trained model locally)

# python harm\_demo.py --cli    # terminal version
